...
artefatti tramite l'esecutore Codex in abbonamento, con `CODEX_HOME` privato
di progetto. Il client d'origine è provenienza, non seleziona un altro provider.
...
`login-codex --device-auth`, mantenendo privati codici login e token gestore.
