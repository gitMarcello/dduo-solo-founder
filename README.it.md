...
per gli embedding (ricerca semantica) e **un solo** login in abbonamento
supportato: Codex oppure Claude. La prima chat supportata del progetto stabilisce
la preferenza per il sonno; prima di ogni consolidamento l'host la verifica e
può usare l'altro abbonamento già verificato sull'host solo se quello preferito
non è disponibile. I collaboratori usano il proprio accesso al client di chat e
i servizi di memoria del gestore.
...
- [Registro di accettazione lifecycle VS Code](docs/vscode-lifecycle-validation.it.md)
...
richiedono una prova reale nella chat grafica prima di poter essere dichiarate
supportate: hook pronti e manifest standard non provano il lifecycle completo.
