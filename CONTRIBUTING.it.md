...
1. Aggiornare tutte le versioni, il changelog e la presentazione bilingue in
   `.github/release-notes/<VERSION>.md`. La pubblicazione legge le note
   dall'archivio verificato, non dai riepiloghi automatici delle PR.
